...
<div class="main-content">
    <div class="container-fluid">
        <div class="page-header">
            <h2 class="header-title">Add New Staff</h2>
            <div class="header-sub-title">
                <nav class="breadcrumb breadcrumb-dash">
                    ...
                    <a class="breadcrumb-item active" href="{{ route('admin-staff-add') }}">Add Staff</a>
                </nav>
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin-staff-store') }}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="staff_username" class="form-control @error('staff_username') error @enderror" placeholder="Name" value="{{ old('staff_username') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="email" name="staff_email" class="form-control @error('staff_email') error @enderror" placeholder="Email" value="{{ old('staff_email') }}">
                          @error('staff_email')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="password" name="staff_password" class="form-control @error('staff_password') error @enderror" placeholder="Password" value="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" name="staff_Mob" class="form-control @error('staff_Mob') error @enderror" placeholder="Phone" value="{{ old('staff_Mob') }}">
                          @error('staff_Mob')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-8">
                            <div class="col-sm-12 row">
                                @foreach ($menuLists as $menu)
                                    <div class="col-sm-6">
                                        <div class="checkbox">
                                            <input id="checkbox{{ ($loop->index + 1) }}" type="checkbox" value="{{ $menu['menu_id'] }}" name="menu_permission[]" class="@error('menu_permission') error @enderror">
